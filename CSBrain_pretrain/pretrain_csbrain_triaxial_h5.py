...
def main():
    parser = argparse.ArgumentParser(description="CSBrain pretraining with tri-axial block replacement")
    ...
    parser.add_argument("--dim_feedforward", type=int, default=800, help="kept for compatibility; unused in tri-axial model")
    ...
    parser.add_argument("--channel_indices", type=str, default="all", help="selected source channel indices; use 'all' to keep all channels")
