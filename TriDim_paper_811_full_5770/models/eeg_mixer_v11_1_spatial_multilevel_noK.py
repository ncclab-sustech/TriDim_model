...
class TriAxisMixerBlock(nn.Module):
    ...
    def __init__(
        ...
        self.attn_fusion_logits = nn.Parameter(torch.zeros(2))
        self.mlp_fusion_logits  = nn.Parameter(torch.zeros(2))
