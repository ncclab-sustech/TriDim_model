...
class TriAxisMixerBlock(nn.Module):
    ...
    def __init__(
        ...
        #self.attn_fusion_logits = nn.Parameter(torch.zeros(1))
        #self.mlp_fusion_logits  = nn.Parameter(torch.zeros(1))
    ...
    def _attn_branch(self, x: torch.Tensor) -> torch.Tensor:
        ...
        return c_out #+ w[1] * k_out + w[2] * t_out
